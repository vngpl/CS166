...
public class EmbeddedSQL {
   ...
   public static void Query1(EmbeddedSQL esql){
      try {
         String query = "SELECT S.sname, COUNT(*) AS totalParts FROM suppliers S JOIN catalog C ON S.sid = C.sid GROUP BY S.sname;";
         int rowCount = esql.executeQuery(query);
         System.out.println("total row(s): " + rowCount);
      }
      catch(Exception e){
   ...
   public static void Query2(EmbeddedSQL esql){
      try {
         String query = "SELECT S.sname, COUNT(*) AS totalParts FROM suppliers S JOIN catalog C ON S.sid = C.sid GROUP BY S.sname HAVING COUNT(*) >= 3;";
         int rowCount = esql.executeQuery(query);
         System.out.println("total row(s): " + rowCount);
      }
      catch(Exception e){
   ...
   public static void Query3(EmbeddedSQL esql){
      try {
         String query = "SELECT S.sname, COUNT(*) AS totalParts FROM suppliers S JOIN catalog C ON S.sid = C.sid JOIN parts P ON P.pid = C.pid WHERE P.color = 'Green' GROUP BY S.sname HAVING COUNT(DISTINCT P.color) = 1;";
         int rowCount = esql.executeQuery(query);
         System.out.println("total row(s): " + rowCount);
      }
      catch(Exception e){
   ...
   public static void Query4(EmbeddedSQL esql){
      try {
         String query = "SELECT S.sname, MAX(C.cost) AS mostExpensive FROM suppliers S JOIN catalog C ON S.sid = C.sid JOIN parts P ON P.pid = C.pid WHERE P.color IN ('Green', 'Red') GROUP BY S.sname HAVING COUNT(DISTINCT P.color) = 2;";
         int rowCount = esql.executeQuery(query);
         System.out.println("total row(s): " + rowCount);
      }
      catch(Exception e){
   ...
   public static void Query5(EmbeddedSQL esql){
      try {
         String query = "SELECT P.pname FROM parts P JOIN catalog C ON P.pid = C.pid WHERE cost < ";
         System.out.print("\tEnter cost: $");
         String input = in.readLine();
         query += input;
   ...
   public static void Query6(EmbeddedSQL esql){
      try {
         String query = "SELECT S.address FROM suppliers S JOIN catalog C ON S.sid = C.sid JOIN parts P ON P.pid = C.pid WHERE P.pname = \'";
